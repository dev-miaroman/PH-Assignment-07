  ...
  return (
    <nav>
      <div className="navbar bg-base-100 shadow-sm">
        <div className="navbar-start container mx-auto flex-1">
          ...
          <Link href={"/"} className="text-3xl font-bold text-[#244d3f]">
            <span className="text-black font-black pl-5">Keen</span>Keeper
          </Link>
        </div>
