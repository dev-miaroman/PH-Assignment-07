  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="input input-bordered w-full bg-zinc-50 border-zinc-200 pl-9 focus:outline-none focus:border-[#244d3f]-300 hover:bg-green-50 hover:border-[#244d3f]-200 transition-colors"
