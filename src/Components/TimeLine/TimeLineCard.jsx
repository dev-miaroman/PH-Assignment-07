    ...
    <>
      {isEmpty ? (
        <div className="flex flex-col items-center justify-center gap-5 py-20 px-6 text-center rounded-xl border-2 border-dashed border-zinc-200 bg-white">
          ...
          <span className="px-4 py-1.5 rounded-full bg-[#244d3f]-50 border border-[#244d3f]-200 text-green-600 text-xs font-semibold tracking-wide uppercase">
            No interactions yet
          </span>
        </div>
      ) : (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="leading-tight">
                  <span className="text-2xl font-semibold text-[#244d3f]-900">
                    {timeLineInfo.type}
                  </span>
